...
public class Testcase {
	...
	public Testcase(boolean isPublic, String testcaseName, Language language, String testcaseDescription,
			String testcaseParamAttr, String testcaseCode,User user) {
		super();
	...
	public Testcase(Long testcaseId, boolean isPublic, String testcaseName, Language language,
			String testcaseDescription, String testcaseParamAttr, String testcaseCode,User user) {
		this(isPublic, testcaseName, language, testcaseDescription, testcaseParamAttr, testcaseCode,user);
