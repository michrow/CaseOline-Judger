...
public class TestcaseParse {
	...
	public static String parseTestcase(String basePath, String testcaseCode) {
		String fileName = createFile(testcaseCode, basePath);
		JSONObject compileResult = compile(basePath);
	...
	private static String createFile(String code, String basePath) {
	...
	private static JSONObject compile(String basePath) {
