...
import caseonline.judger.web.mapper.ExcellenceUsecaseMapper;
...
public class SubmissionService {
	...
	public Map<String, Object> addSubmission(User currentUser, long testcaseId, int languageId,
		...
		if (Verifyresult.get("isSuccessful")) {
				...
				Submission submission = new Submission(testcase, currentUser, language, SubmissionTime, originUsecase,
						0);
	...
	public List<ExcellenceUsecase> getExcellentUsecase(Long testcaseId,float usecaseCoverage){
		return	excellenceUsecaseMapper.selectUsecaseByConditon(testcaseId, usecaseCoverage);
	}
