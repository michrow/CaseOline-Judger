...
<body>
            ...
            <div id="content">
                ...
                <div id="filters" class="row-fluid">
                    ...
                    <div class="span8 text-right">
                        <form action="<c:url value="/admin/user/all-users" />" method="GET" class="row-fluid">
                            <div class="span4">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr data-value="${user.userId}">
                            ...
                            <td class="username">
                                <a href="<c:url value="/admin/user/edit-user/${user.userId}" />">${user.userName}</a>
                            </td>
                            <td class="email">${user.email}</td>
                            <td class="user-group">${user.role.roleName}</td>
                            <td class="prefer-language"> <fmt:formatDate
                ...
                <div id="pagination" class="pagination pagination-centered">
                    ...
                    <c:set var="baseUrl" value="/admin/user/all-users?roleType=${selectedRole}&username=${username}" />
                    <ul>
    ...
    <script type="text/javascript">
        $('button.btn-danger', '#filters').click(function() {
            ...
            $('button.btn-danger', '#filters').html('等待');
    ...
    <script type="text/javascript">
        function doDeleteUsersAction(users) {
            ...
            $.ajax({
                type: 'POST',
                url: '<c:url value="/admin/user/deleteUsers.action" />',
                data: postData,
                dataType: 'JSON',
