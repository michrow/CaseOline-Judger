...
<body>
        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div id="filters" class="row-fluid">
                    ...
                    <div class="span6">
                        <form class="row-fluid text-right" action="<c:url value="/admin/submission/all-submissions" />">
                            <div class="span5">
                ...
                <div id="pagination" class="pagination pagination-centered">
                    ...
                    <c:set var="baseUrl" value="/admin/submission/all-submissions?testcaseId=${testcaseId }&username=${username }" />
                    <ul>
    ...
    <script type="text/javascript">
        function doDeleteSubmissionsAction(submissions) {
            ...
            $.ajax({
                type: 'POST',
                url: '<c:url value="/admin/submission/deleteSubmissions.action" />',
                data: postData,
                dataType: 'JSON',
