            ...
            <div id="main-content" class="span9">
                <div class="submission">
                    ...
                    <div class="body">
                        ...
                        <c:if test="${submission.user == myProfile or myProfile.role.roleType == 'administrators'}">
                        <div class="section">
                            <h4>提交用例</h4>
                            <div class="description">
                                <pre><code>${submission.usecase.replace("<", "&lt;").replace(">", "&gt;")}</code></pre>
                            </div> <!-- .description -->
                        </div> <!-- .section -->
                        </c:if>
                    </div> <!-- .body -->
            ...
            $.ajax({
                ...
                success: function(result){
                    if ( result['isSuccessful'] ) {
                        if ( result['submission']['judgeResult']['resultName'] != 'PD' ) {
